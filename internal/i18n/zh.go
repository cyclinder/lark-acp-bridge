...
var zh = map[string]string{
	...
	"/new-issue <repo> [--last N] [--since today|24h|7d] [extra prompt] — summarize recent group messages into a GitHub issue": "/new-issue <仓库> [--last N] [--since today|24h|7d] [附加提示词]（/新建议题）— 将近期群消息总结成 GitHub issue",
	"/new-issue spidernet-io/spiderpool — collect the latest 500 group messages, auto-summarize and file an issue (default)":   "/new-issue spidernet-io/spiderpool — 收集最近 500 条群消息，自动总结并提交 issue（默认）",
	"/new-issue spidernet-io/spiderpool --last 100 — collect only the last 100 messages":                                       "/new-issue spidernet-io/spiderpool --last 100 — 只收集最近 100 条消息",
	"/new-issue spidernet-io/spiderpool focus on the RDMA discussion — extra free text guides the summary":                     "/new-issue spidernet-io/spiderpool 重点看 RDMA 的讨论 — 附加自定义提示词引导总结",
